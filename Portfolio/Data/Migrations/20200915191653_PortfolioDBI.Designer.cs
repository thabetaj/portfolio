...
namespace Portfolio.Data.Migrations
{
    ...
    [Migration("20200915191653_PortfolioDBI")]
    partial class PortfolioDBI
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Data.UserSkill", b =>
                {
                    b.Property<int>("InterpersonalSkillsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("InterpersonalSkillsId", "UserId", "TechnicalSkillsId");

                    b.HasIndex("TechnicalSkillsId");

                    b.HasIndex("UserId");

                    b.ToTable("UserISkills");
                });
            ...
            modelBuilder.Entity("Portfolio.Data.UserSkill", b =>
                {
                    b.HasOne("Portfolio.Data.InterpersonalSkills", "InterpersonalSkill")
                        .WithMany("UserSkills")
                        .HasForeignKey("InterpersonalSkillsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Portfolio.Data.TechnicalSkills", "TechnicalSkill")
                        .WithMany("UserSkills")
